 ...
 */
public class RxLocationProvider implements LocationProvider, GoogleApiClient.ConnectionCallbacks,
    ...
    private Subscriber<? super RxLocationProvider.ProviderWrapper> subscriber;
    ...
    public void checkLocationSettings() {
        LocationRequest requestL = LocationRequest.create()
                .setFastestInterval(1000)
                .setInterval(2000)
                .setSmallestDisplacement(10);

        LocationSettingsRequest request = new LocationSettingsRequest.Builder().addLocationRequest(requestL).build();
        ...
        public void onResult(LocationSettingsResult locationSettingsResult) {
            ...
            switch (status.getStatusCode()) {
                case LocationSettingsStatusCodes.SUCCESS:
                    ...
                    fulfilledCheckLocationSettings = true;
                    startUpdating(locationRequest);
                    subscriber.onNext(new ProviderWrapper(LocationStatus.ENABLED, RxLocationProvider.this));
                    break;
                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                    ...
                    subscriber.onNext(new ProviderWrapper(LocationStatus.DISABLED, RxLocationProvider.this));
                    break;
                case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                    logger.i("Location settings are inadequate, and cannot be fixed here. Dialog " +
                            "not created.");
                    stop();
                    subscriber.onNext(new ProviderWrapper(LocationStatus.HELPLESS, RxLocationProvider.this));
                    break;
            }
        }
    };
    ...
    public enum LocationStatus {
        STALED, DISABLED, ENABLED, HELPLESS
    }
